        ...
        <div class="col-xl-10 col-lg-12 col-md-9">
            <div class="card o-hidden border-0 shadow-lg my-5">
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div class="col-lg-5 d-none d-lg-block bg-reset-password"></div>
                        <div class="col-lg-7">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-2">{{ __('Password Recovery') }}</h1>
                                    <p class="mb-4">{{ __('Enter your new password, and remember it well') }}</p>
                                </div>
