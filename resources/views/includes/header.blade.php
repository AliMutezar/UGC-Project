                    ...
                    <ul id="mainmenu">
                        ...
                        <li><a href="/services" class="{{ Request::is('services') ? 'active' : '' }}">Services</a>
                            <ul>
                                ...
                                <li><a href="/services-detail">Ocean Freight</a></li>
                                <li><a href="/services-detail">Air Freight</a></li>
                                <li><a href="/services-detail">Cargo Express</a></li>
                                <li><a href="/services-detail">Logistics</a></li>
                                <li><a href="/services-detail">Warehousing</a></li>
                                <li><a href="/services-detail">Custom Brokerage</a></li>
                            </ul>
                        </li>
