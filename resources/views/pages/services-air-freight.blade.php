                ...
                <div class="row">
                    <div class="col-md-5 wow fadeInRight" data-wow-delay=".5s" data-wow-duration=".8s">
                        ...
                        <p class="lead" style="text-align:justify;">
                            Air Freight merupakan salah satu jenis transportasi yang menggunakan mode udara untuk pengiriman barang dari tempat asal ke tujuan. Perkembangan angkutan udara sejalan dengan perkembangan yang menghasilkan barang bernilai atau mudah rusak, sehingga lebih memilih angkutan udara untuk tempat tujuan. Anda juga bosa menyewa satu pesawat penuh untuk pengiriman barang yang bersifat project. Hal ini tentu dengan pertimbangan efisiensi.
                        </p>

                        <p class="lead" style="text-align:justify;">
                            Layanan ini menggunakan dan membandingkan volume, dimensi, dan tonase (kapasitas ruang muat dalam armada) sebagai dasar dalam memperhitungkan biaya jasa pengiriman.
                        </p>
