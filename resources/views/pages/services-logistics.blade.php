                ...
                <div class="row">
                    <div class="col-md-5 wow fadeInRight" data-wow-delay=".5s" data-wow-duration=".8s">
                        ...
                        <p class="lead" style="text-align:justify;">
                            Jasa Logistics merupakan jasa yang menyediakan pengiriman barang dalam skala keci, menengan maupun besar. Dengan penentuan tarif kirim berdasarkan berat barang, jarak pengiriman, dan jenis layanan pengiriman yang digunakan oleh pengguna. Pengiriman barang melalui jasa pengiriman logistik meliputi pengiriman darat, pengiriman laut, pengiriman udara, dan pengiriman kereta api. Untuk wilayah jangkauan jasa pengiriman logistik dapat menawarkan pengiriman antar kota, antar provinsi, dan antar pulau. Setiap jasa pengiriman logistik biasanya mempunyai satu kantor utama, beberapa kantor cabang, serta gudang yang gedungnya tersebar d beberapa kota di Indonesia.
                        </p>

                        <p class="lead" style="text-align:justify;">
                            Dapat menjangkau pengiriman dengan berbagai macam jenis barang, yang bisa di Import, Export maupun pengiriman Domestic. Pengiriman logistik menyediakan charter truck yang dapat memberikan fungsi pengiriman dengan waktu yang lebih cepat dibandingkan pengiriman pada umumnya.
                        </p>

                        <p class="lead" style="text-align:justify;">
                            Pengiriman menjadi lebih cepat dibandikan dengan pengiriman lainnya. Cocok untuk pengiriman yang bersifat urgent.
                        </p>
